...
from quod_worker.config import FIXTURES_DIR
from quod_worker.models import Anchor, Card, Doc, Edge, Entity, Node
...
def write_dump(conn: psycopg.Connection, out: Path = DEMO_DUMP) -> int:
    ...
    lines: list[str] = [
        "-- Quod demo corpus snapshot. Generated by `quod-worker dump-demo`.",
